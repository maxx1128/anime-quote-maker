export function update(quoteThis) {
  const allUpdates = {
    ...
    posX: (e) => quoteThis.setState({ posX: e.target.value }),
    posY: (e) => quoteThis.setState({ posY: e.target.value }),
    quote: (e) => quoteThis.setState({ quote: e.target.value }),
    bgColor: (e) => quoteThis.setState({ bgColor: e.target.value }),
    textColor: (e) => quoteThis.setState({ textColor: e.target.value }),
    style: (style) => quoteThis.setState({ style: style }),
    fontStyle: (fontStyle) => quoteThis.setState({ fontStyle: fontStyle }),
    fontFamily: (e) => quoteThis.setState({ fontFamily: e.target.value }),
    tags: (newTags) => quoteThis.setState({ tags: newTags }),
    size: (e) => quoteThis.setState({ size: e.target.value }),
